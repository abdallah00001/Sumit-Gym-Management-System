...
/**
 * Convenience function for appending requset params to url.
 * @param {string} endpoint - The API endpoint (relative to base URL).
 * @param {object} params - Parameters to be passed.
 * @returns {String} - Final url with params attached; 
 */
function appendRequestParams(endpoint, params) {
...
//Helpful for creating each endpoint url
function appendToGenericEndPoint(endpoint, extension) {
